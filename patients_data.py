...
#######Updation and deletion of patient details#####
...
def D_display():
    ...
    rootD=tkinter.Tk()
    rootD.resizable(height=False,width=False)
...
def up1():
    ...
    if len(p) != 0:
        ...
        tkinter.messagebox.showinfo("DATABASE SYSTEM", "DETAILS UPDATED INTO DATABASE")
        conn.commit()

    else:
        tkinter.messagebox.showwarning("DATABASE SYSTEM", "PATIENT IS NOT REGISTERED")
...
def P_UPDATE():
    ...
    rootU = tkinter.Tk()
    rootU.title(" ")
    rootU.resizable(height=False,width=False)
    ...
    sex = tkinter.Label(rootU, text="GENDER")
